...
export async function POST(request: NextRequest) {
  try {
    ...
    const referral = backendStore.createReferral({
      ...
      referringDoctorSpecialty: body.referringDoctorSpecialty,
      referringDoctorQualification: body.referringDoctorQualification,
      referringDoctorRegNo: body.referringDoctorRegNo,
      referringDoctorHospital: body.referringDoctorHospital,
