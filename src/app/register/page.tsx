    ...
    setTimeout(() => {
      ...
      if (accountType === 'super_admin') {
        ...
        submitMarketingJoinRequest({
          ...
          gender: 'Male',
          fatherOrMotherName: 'Parent Guardian',
          dob: '1995-01-01',
          bloodGroup: 'O+',
          aadharNumber: 'XXXX-XXXX-XXXX',
          panNumber: 'XXXXX0000X',
          drivingLicenceNumber: 'DL-0000000000',
          address: 'Corporate Enclave',
          pinCode: '400001',
...
export default function RegisterPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-[#f0fdf4] flex items-center justify-center text-[#046a4e] font-bold">Loading Registration Portal...</div>}>
      <RegisterPageContent />
    </Suspense>
  );
}