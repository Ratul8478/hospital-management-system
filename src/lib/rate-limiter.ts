...
// 1. Strict Auth Limit: 10 attempts per minute per IP (Defends against brute-forcing)
export const authRateLimiter = new SlidingWindowRateLimiter(10, 60000);

// 2. Standard API Limit: 120 requests per minute per IP
export const apiRateLimiter = new SlidingWindowRateLimiter(120, 60000);

// 3. Strict Mutation / Registration Limit: 20 submissions per minute per IP
export const registrationRateLimiter = new SlidingWindowRateLimiter(20, 60000);
